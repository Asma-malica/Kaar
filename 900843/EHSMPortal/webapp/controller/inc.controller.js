sap.ui.define([
	...
	return Controller.extend("NITHYAEHSMNITHYAEHSM.controller.inc", {
		onLogins : function(){
   ...
   //      },
         onInit: function(){
			...
			oe.read("/ZPB_EHSM_INCIDENTSet?$filter=IPlant eq '0001'&$format=json",{
				context:null,
				urlParameter:null,
				async:false,
		 ...
		 * @memberOf NITHYAEHSMNITHYAEHSM.view.inc
		 */
		//	onInit: function() {
		//
		//	},
