sap.ui.define([
	...
	return Controller.extend("NITHYASHOPFLOOR1NITHYASHOPFLOOR1.controller.pur", {
		onLogins : function(){
   ...
   //      },
         onInit: function(){
			...
			oe.read("/ZPB_SHOPFLOOR_PRODORDERSet?$filter=IMrpController eq '010' and IProductionPlant eq '0001'&$format=json",{
				context:null,
				urlParameter:null,
				async:false,
		 ...
		 * @memberOf NITHYASHOPFLOOR1NITHYASHOPFLOOR1.view.pur
		 */
		//	onInit: function() {
		//
		//	},
